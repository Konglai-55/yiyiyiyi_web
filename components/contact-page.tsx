...
export default function ContactPage() {
  ...
  async function copyPhone() {
    try { await navigator.clipboard.writeText('4006222119'); setCopyStatus('号码已复制'); }
    catch { setCopyStatus('请长按或选中号码复制：4006-222-119'); }
  }
  return <div className="corporate contact-page" id="top">
    ...
    <main>
      <section className="contact-intro">
        <div className="c-shell contact-intro-grid">
          ...
          <div className="contact-direct"><div className="contact-direct-top"><p className="contact-eyebrow">项目咨询邮箱</p><span className="contact-status-dot">在线接收</span></div><a className="contact-email-primary" href="mailto:yiyiyiyi@yyyybj.cn">yiyiyiyi@yyyybj.cn</a><p className="contact-lead">发送项目需求、现场资料或合作计划，我们会根据场景给出设备、平台与运维建议。</p><div className="contact-person"><span>联系人　熊贵齐</span><span>电话　<a href="tel:4006222119">4006-222-119</a></span></div><div className="contact-actions"><a href="mailto:yiyiyiyi@yyyybj.cn">发送邮件 <ArrowUpRight size={19} /></a><a href="tel:4006222119"><PhoneCall size={19} />拨打电话</a><button type="button" onClick={copyPhone}><Copy size={18} />复制电话</button></div><p className="contact-copy-status" role="status" aria-live="polite">{copyStatus || '工作日通常会在 1 个工作日内回复。'}</p><p className="contact-safety">如遇火情，请及时拨打 119。</p></div>
        </div>
      </section>
    ...
    <footer className="c-footer"><div className="c-shell contact-footer"><div><h2>壹壹壹壹</h2><p>（北京）安全技术有限公司</p></div><nav aria-label="页脚导航"><a href="/">首页</a><a href="/products">产品展示</a><a href="/products/smoke">AI 大数据烟感</a><a href="/#projects">项目案例</a></nav><div className="contact-footer-contact"><a href="tel:4006222119">项目咨询：4006-222-119</a><a href="mailto:yiyiyiyi@yyyybj.cn">邮箱：yiyiyiyi@yyyybj.cn</a></div></div><div className="c-shell c-copyright"><span>© 2026 壹壹壹壹（北京）安全技术有限公司</span><a href="#top">回到顶部 <ArrowUpRight /></a></div></footer>
  </div>;
}
